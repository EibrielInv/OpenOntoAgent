export class SemanticStructure {
    ...
    addSemStruc(semstruc: any, lexicalsense_id: number) :number {
        const semstruc_id = this.ontoagent.datascript.dbAdd(null, "semantic-structure/id", this.current_semstruc_id)
        this.current_semstruc_id++
        this.ontoagent.datascript.dbAdd(lexicalsense_id, "sense/semantic-structure", semstruc_id)
    ...
    addSemStrucConceptProperty(concept_name: string, properties: any, lexicalsense_id: number) {
        const ssproperty_id = this.ontoagent.datascript.dbAdd(null, "semantic-structure.concept.property/name", concept_name)
        this.ontoagent.datascript.dbAdd(lexicalsense_id, "semantic-structure.concept.property/property", ssproperty_id)
        if (typeof properties === 'string') {
            this.ontoagent.datascript.dbAdd(ssproperty_id, "semantic-structure.concept.property/value", properties)
